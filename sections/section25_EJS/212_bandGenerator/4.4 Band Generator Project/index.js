...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", {dyYear: dynamicYear, title:"Click to the button to generate name"});
});

app.post("/submit", (req, res) => {
  //Step 2 - Make the generate name functionality work
  title = generateRandomName() ; 
  res.render("index.ejs", {dyYear: dynamicYear, title: title});
...
function generateRandomName() {
  ...
  var adjName = adj[random] ; 

  random = Math.floor(Math.random() * noun.length); 
  var nounName = noun[random] ;
  
  return adjName + " " + nounName ; 
}
